...
IDs e estados são estáveis; T-009 não substitui aceites individuais. `T-004` é a tarefa de continuidade do checkpoint; não usar estado documental para anunciar MVP pronto. A fatia offline de T-003 é independente da integração final e não desbloqueia T-006 até um teste real da Groq.
